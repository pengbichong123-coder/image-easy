...
const SLOGAN: Record<string, { eyebrow: string; title: string; sub: string }> = {
  ...
  ja: {
    eyebrow: "AI画像作成を",
    title: "もっと集中。",
    sub: "実運用向けの5つのAI画像モデルを、ひとつのワークスペースで。",
  },
  ko: {
    eyebrow: "AI 이미지 생성",
    title: "더 집중되게.",
    sub: "프로덕션 수준의 AI 이미지 모델 다섯 가지를 하나의 워크스페이스에서.",
  },
  fr: {
    eyebrow: "Création d’images IA",
    title: "sans distraction.",
    sub: "Cinq modèles d’image IA prêts pour la production dans un seul espace.",
  },
  de: {
    eyebrow: "KI-Bilderstellung",
    title: "fokussiert.",
    sub: "Fünf produktionsreife KI-Bildmodelle in einem Workspace.",
  },
  es: {
    eyebrow: "Creación de imágenes IA",
    title: "más enfocada.",
    sub: "Cinco modelos de imagen IA listos para producción en un espacio.",
  },
  it: {
    eyebrow: "Creazione immagini IA",
    title: "più focalizzata.",
    sub: "Cinque modelli IA per immagini pronti per la produzione in un workspace.",
  },
  nl: {
    eyebrow: "AI-afbeeldingen maken",
    title: "met focus.",
    sub: "Vijf productieklare AI-beeldmodellen in één workspace.",
  },
};
